...
\begin{enumerate}
    ...
    You may use the table from the article \url{https://en.wikipedia.org/wiki/Moment-generating_function}.
    
    \item Consider the moment-generating function $g(t) = \frac{\exp(3t) - 1}{3t\exp(-2t)}$ of a random variable $X$.
